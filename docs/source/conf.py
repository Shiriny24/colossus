# -*- coding: utf-8 -*-
#
# Colossus documentation build configuration file, created by
# sphinx-quickstart on Wed Dec  3 21:57:20 2014.
#
...
project = 'Colossus'
copyright = '2014-2022, Benedikt Diemer'
...
if html_theme == 'scipy':
	...
	image_path = theme_path + 'scipy/static/img/scipy_org_logo.gif'
	cp_cmd = 'cp %s %s' % (logo_path, image_path)
	os.system(cp_cmd)
...
html_title = 'Colossus Documentation'
